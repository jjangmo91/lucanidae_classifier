...
im(s, Inches(0.4), Inches(2.35), Inches(6.2), Inches(2.25),
   "fig_multitask_effect.png (SO vs SX vs FO vs MT)")
im(s, Inches(0.4), Inches(4.7),  Inches(6.2), Inches(2.4),
   "fig_female_vs_male_accuracy.png (SO test, N2 수컷 다형성 증거)")

# 결과표
cd(s, Inches(6.85), Inches(2.35), Inches(6.05), Inches(4.75))
tx(s,"MT Ablation 결과표",
   Inches(7.0), Inches(2.45), Inches(5.7), Inches(0.42), sz=13, b=True, c=A2)

headers = [("Mode",7.0,1.3),("Val Acc",8.45,1.1),("Sex Acc",9.65,1.0),("비고",10.75,1.95)]
...
# 하단 해석 — 3구역으로 분리
cd(s, Inches(6.85), Inches(5.88), Inches(6.05), Inches(1.18))

# N1 (SX 효과 + 주의)
tx(s,"SX: val +1.0%p (N1 잠정) — test에서 역전 (SX 70.4% < SO 72.9%)",
   Inches(7.0), Inches(5.95), Inches(4.0), Inches(0.38), sz=10.5, c=WH)
tx(s,"→ val 과적합 가능성, 데이터 확장 후 재검증 필요",
   Inches(7.0), Inches(6.35), Inches(4.0), Inches(0.32), sz=10.5, c=GR)

# DINOv2
tx(s,"DINOv2 SX: 5.7% → 완전 붕괴",
   Inches(11.1), Inches(5.95), Inches(1.65), Inches(0.35), sz=10, c=RD)
tx(s,"Self-supervised backbone은",
   Inches(11.1), Inches(6.3), Inches(1.65), Inches(0.32), sz=10, c=GR)
tx(s,"multi-task gradient에 민감",
   Inches(11.1), Inches(6.62), Inches(1.65), Inches(0.32), sz=10, c=GR)

# N2 (하단 차트 해석)
tx(s,"하단 차트: 수컷이 모든 아키텍처에서 암컷보다 낮음 (N2 형태 다형성 증거)",
   Inches(0.5), Inches(7.18), Inches(8.0), Inches(0.28), sz=10.5, c=YL)

pr.save("beetledex_midterm_2026_MT수정.pptx")
print("저장: beetledex_midterm_2026_MT수정.pptx")
