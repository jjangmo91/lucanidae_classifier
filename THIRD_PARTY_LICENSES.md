...
**1. 서비스 운영 (beetledex.com)**
서비스 이용자에게 전체 애플리케이션의 대응 소스를 제공할 수 있어야 한다.
저장소가 **공개 상태라면 사실상 충족**된다. 비공개라면 충족되지 않는다.

> 확인 필요: GitHub 저장소가 public 인지 private 인지.
> private 이면 아래 선택지 중 하나를 골라야 한다.
...
- [ ] **저장소 public/private 확인** — private 이면 AGPL 13조 미충족
